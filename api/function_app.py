...
# @app.cosmos_db_output(arg_name="dogWalkerDocument", database_name="waggly-database", container_name="waggly-container", connection="CosmosDbConnectionSetting")

def createWalker(req: func.HttpRequest) -> func.HttpResponse:
